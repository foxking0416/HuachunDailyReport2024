...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_3.addAction(self.qtCreateNewProjectAction)
        self.menu_3.addAction(self.qtEditProjectAction)
        self.menu_4.addAction(self.qtSelectProjectAction)
        self.menu_4.addAction(self.qtCreateNewDailyReportAction)
        self.menu_4.addAction(self.qtEditDailyReportAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_2.setTitle(QCoreApplication.translate("MainWindow", u"\u57fa\u672c\u8cc7\u6599\u7dad\u8b77", None))
        self.menu_3.setTitle(QCoreApplication.translate("MainWindow", u"\u5de5\u7a0b\u8cc7\u6599\u7dad\u8b77", None))
